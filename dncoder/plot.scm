...
(do-func-plot #t 0  15  0  30  myfunc  "points")

(pretty-print (make-gnuplot d))
...
(format #t "~a" (do-func-plot "gnuplot"   #:xmin 0 #:xmax 15 #:ymin 0 #:ymax 30 #:func myfunc #:brush "points") )
(format #f "~a" (make-gnuplot '("a" "b"))

(open-input-output-pipe (format #f "~a" (do-func-plot #t 0  15  0  30  myfunc  "points")))
